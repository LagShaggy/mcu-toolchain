...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA5     ------> ADC1_IN10
    */
    HAL_GPIO_DeInit(DMCI_DATAIN_GPIO_Port, DMCI_DATAIN_Pin);
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP2_MspDeInit 0 */
    ...
    PB5     ------> COMP2_OUT
    */
    HAL_GPIO_DeInit(GPIOB, comp2_INP_Pin|Comp2_OUT_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PG8     ------> LPUART1_RX
    */
    HAL_GPIO_DeInit(GPIOG, LPUART_TX_Pin|LPUART_RX_3V3_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB7     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOG, USART1_CTS_3V3_Pin|USART1_RTS_Pin);

    HAL_GPIO_DeInit(GPIOB, USART1_TX_Pin|USART1_IrDA_RX_3V3_Pin);
...
void HAL_SMARTCARD_MspDeInit(SMARTCARD_HandleTypeDef* hsmartcard)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB0     ------> USART3_CK
    */
    HAL_GPIO_DeInit(SmartCard_IO_GPIO_Port, SmartCard_IO_Pin);

    HAL_GPIO_DeInit(SmartCard_CLK_GPIO_Port, SmartCard_CLK_Pin);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  /* USER CODE END OPAMP1_MspDeInit 0 */
    ...
    PA3     ------> OPAMP1_VOUT
    */
    HAL_GPIO_DeInit(GPIOA, OpAmp1_INP_Pin|OpAmp1_INM_Pin|OpAmp1_OUT_Pin);
...
void HAL_HCD_MspDeInit(HCD_HandleTypeDef* hhcd)
{
  ...
  /* USER CODE END USB_OTG_FS_MspDeInit 0 */
    ...
    PA12     ------> USB_OTG_FS_DP
    */
    HAL_GPIO_DeInit(GPIOA, USBOTG_VBUS_Pin|USBOTG_ID_Pin|USBOTG_DM_Pin|USBOTG_DP_Pin);
...
static void HAL_FMC_MspDeInit(void){
  ...
  PE1   ------> FMC_NBL1
  */
  HAL_GPIO_DeInit(GPIOE, A23_Pin|A19_Pin|A20_Pin|A21_Pin
                          |A22_Pin|D4_Pin|D5_Pin|D6_Pin
                          |D7_Pin|D8_Pin|D9_Pin|D10_Pin
                          |D11_Pin|D12_Pin|FMC_NBL0_Pin|FMC_NBL1_Pin);
  ...
  HAL_GPIO_DeInit(GPIOG, A10_Pin|A11_Pin|A12_Pin|A13_Pin
                          |A14_Pin|A15_Pin|FMC_NE2_Pin|LCD_NE3_Pin);

  HAL_GPIO_DeInit(GPIOD, D13_Pin|D14_Pin|D15_Pin|A16_Pin
                          |A17_Pin|A18_Pin|D0_Pin|D1_Pin
                          |D2_Pin|D3_Pin|FMC_NOE_Pin|FMC_NWE_Pin
                          |FMC_NE1_Pin);
...
/* SAI1 */
    ...
    */
    ...
    PF9     ------> SAI1_FS_B
    */
    HAL_GPIO_DeInit(GPIOF, SAI1_SDB_Pin|SAI1_MCKB_Pin|SAI1_SCKB_Pin|SAI1_FSB_Pin);
